...
1. Pseudocode should be more specific than i thought.
2. Hashes make more sense. Arrays would have to be nested (e.g. an array of arrays, where each interior array had two values - item and quantity)
3. A method returns its return value.
4. Any type of data/variable can be a method argument
5. You can pass info between methods by using the output (return) of one as the input for another.
6. Pseudocode specificity was locked in. Still unclear on how to deal with potentially empty parameters (see add_item method(s) above)
